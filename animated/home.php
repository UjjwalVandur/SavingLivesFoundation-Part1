    ...
    <style>
        * {
        ...
        .background .home-image {
            ...
            animation: MainImg 1s ease-in-out 1 forwards;
        }
        ...
        .background .slogans {
            ...
            z-index: 1;
            animation: slogan 2s ease-in-out 1 forwards;
        }
        ...
        .background .image-slider {
            ...
            animation: img-slider 2s ease-in-out 1 forwards;
        }
        ...
        .footer .companyname {
            ...
            animation: footer-comp 1s ease-in-out 1 forwards;
        }

        @keyframes footer-comp {
            0% {
                left: -300px;
            }
        ...
        .footer .contact {
            ...
            animation: contact 1s ease-in-out 1 forwards;
        }
...
<body>
    ...
    <div class="background">
        <div class="slogans">
            ...
            <p class="description">Our organization works to promote and facilitate blood donation. We organize blood
                drives, provide information about blood donation, and recruit blood donors. We also work to raise
                awareness of the importance of blood donation and dispel some common myths about it. Also, we ensure
                that there is a safe and adequate supply of blood available for patients who need it. <a href="#">Read
                    More...</a></p>
            <button type="submit" class="donate" id="donate"><i class='bx bxs-droplet'></i>DONATE BLOOD</button>
        ...
        <div class="image-slider">
            <div class="images">
                ...
                <p class="image-description">Lorem ipsum dolor sit amet consectetur adipisicing elit. Illum nam vero
                    veniam rerum, ducimus architecto nostrum eaque earum? Odit, iusto. Lorem ipsum dolor sit amet.</p>
            </div>
        </div>
        <div class="home-image"></div>
    </div>
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 50 1440 170">
        <path fill="url(#grad1)" fill-opacity="1"
            d="M0,128L48,117.3C96,107,192,85,288,112C384,139,480,213,576,208C672,203,768,117,864,117.3C960,117,1056,203,1152,208C1248,213,1344,139,1392,101.3L1440,64L1440,0L1392,0C1344,0,1248,0,1152,0C1056,0,960,0,864,0C768,0,672,0,576,0C480,0,384,0,288,0C192,0,96,0,48,0L0,0Z">
        </path>
        <defs>
    ...
    <header class="header">
        ...
        <div class="register-search">
            ...
            <div class="profile-link">
                <div class="profile">
                    <img src="website_images/profile.png">
...
?>
    ...
    <div class="mva-container">
        <div class="mva-block">
            ...
            <div class="mva-content">
                <h5>Our Mission</h5>
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime rem tempora nulla eum corporis
                    omnis, neque rerum obcaecati aperiam modi recusandae nisi explicabo ad, dolore autem quasi adipisci
                    culpa quos hic quisquam maiores? Deleniti ut provident nisi voluptas deserunt tenetur?Lorem ipsum,
                    dolor sit amet consectetur adipisicing elit. Dolores, sapiente! Deserunt nesciunt sed quasi dolorem
                    ab quos eaque pariatur labore eum! Maxime voluptatibus sequi quibusdam dolorem iste maiores
                    voluptatem architecto?</p>
            </div>
        </div>
        <div class="mva-block">
            <div class="mva-image">
            ...
            <div class="mva-content">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime rem tempora nulla eum corporis
                    omnis, neque rerum obcaecati aperiam modi recusandae nisi explicabo ad, dolore autem quasi adipisci
                    culpa quos hic quisquam maiores? Deleniti ut provident nisi voluptas deserunt tenetur?Lorem ipsum
                    dolor, sit amet consectetur adipisicing elit. Ea commodi molestias dolorem odit. Veniam nihil,
                    pariatur quod architecto qui a odio vitae eos! Totam earum quidem eveniet pariatur exercitationem
                    dolorum!</p>
            </div>
        </div>
        <div class="mva-block">
            ...
            <div class="mva-content">
                ...
                <p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Maxime rem tempora nulla eum corporis
                    omnis, neque rerum obcaecati aperiam modi recusandae nisi explicabo ad, dolore autem quasi adipisci
                    culpa quos hic quisquam maiores? Deleniti ut provident nisi voluptas deserunt tenetur?Lorem ipsum
                    dolor sit amet, consectetur adipisicing elit. Recusandae, tempore quia eum reiciendis quaerat
                    accusamus natus, amet, corrupti temporibus ex cumque rem expedita velit. Qui exercitationem illum
                    eius obcaecati aperiam.</p>
            </div>
        </div>
    </div>
    ...
    <div class="mainfooter">
        <div class="footer">
            <div class="companyname">
                ...
                <p>Our organization works to promote and facilitate blood donation. We organize blood drives, provide
                    information about blood donation, and recruit blood donors. </p>
            ...
            <div class="contact">
                ...
                <form action="" method="POST">
                    ...
                    <textarea name="message" id="message" cols="27" rows="10" placeholder="Write your message ..."
                        wrap="hard"></textarea>
    ...
    <!-- End of Home Page -->
    <script>
        document.getElementById("donate").addEventListener("click", redirectFunction);

        function redirectFunction() {
            window.location.href = "http://localhost/SavingLivesFoundation/donor.php";
        }
    </script>
    <?php
$db = mysqli_connect("localhost", "root", "", "savinglivesfoundation");
